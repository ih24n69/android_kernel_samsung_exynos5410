...
ARCH		= arm
CROSS_COMPILE	= ccache ../../toolchains/linaro/arm-linux-androideabi-6.1/bin/arm-linux-androideabi-
...
KBUILD_AFLAGS_MODULE  := $(AFLAGS_MODULE) -DMODULE
KBUILD_CFLAGS_MODULE  := $(CFLAGS_MODULE) -DMODULE
KBUILD_LDFLAGS_MODULE := $(LDFLAGS_MODULE) -T $(srctree)/scripts/module-common.lds
