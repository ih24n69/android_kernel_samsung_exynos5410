...
#ifdef CONFIG_SOC_EXYNOS5410_CA15_OVERCLOCK
#define MAX_FREQ_BLANK				(2000000)
#else
...
#define DEF_FREQUENCY_UP_STEP_LEVEL_L		(650000)
#else
...
#ifdef CONFIG_SOC_EXYNOS5410_CA15_OVERCLOCK
#define MAX_FREQUENCY_UP_STEP_LEVEL		(2000000)
#else
